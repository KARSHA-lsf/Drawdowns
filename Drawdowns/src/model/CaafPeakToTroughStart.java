...
/**
 * CaafPeakToTroughStart generated by hbm2java
 */
@Entity
@Table(name = "caaf_peak_to_trough_start", catalog = "karsha_drawdowns")
public class CaafPeakToTroughStart implements java.io.Serializable {

	private CaafPeakToTroughStartId id;

	public CaafPeakToTroughStart() {
	}

	public CaafPeakToTroughStart(CaafPeakToTroughStartId id) {
		this.id = id;
	}
	...
	public CaafPeakToTroughStartId getId() {
		return this.id;
	}

	public void setId(CaafPeakToTroughStartId id) {
		this.id = id;
	}
