...
/**
 * CaafPeakToTroughEndId generated by hbm2java
 */
@Embeddable
public class CaafPeakToTroughEndId implements java.io.Serializable {
	...
	public CaafPeakToTroughEndId() {
	}

	public CaafPeakToTroughEndId(Integer permno, Integer yrmo, String value1,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaafPeakToTroughEndId))
			return false;
		CaafPeakToTroughEndId castOther = (CaafPeakToTroughEndId) other;
