...
/**
 * CaafDrawdownsId generated by hbm2java
 */
@Embeddable
public class CaafDrawdownsId implements java.io.Serializable {
	...
	public CaafDrawdownsId() {
	}

	public CaafDrawdownsId(Integer permno, Integer yrmo, BigDecimal value1,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaafDrawdownsId))
			return false;
		CaafDrawdownsId castOther = (CaafDrawdownsId) other;
