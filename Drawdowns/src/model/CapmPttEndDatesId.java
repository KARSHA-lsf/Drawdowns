...
/**
 * CapmPttEndDatesId generated by hbm2java
 */
@Embeddable
public class CapmPttEndDatesId implements java.io.Serializable {
	...
	public CapmPttEndDatesId() {
	}

	public CapmPttEndDatesId(Integer permno, Integer yrmo, Integer horizon,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CapmPttEndDatesId))
			return false;
		CapmPttEndDatesId castOther = (CapmPttEndDatesId) other;
