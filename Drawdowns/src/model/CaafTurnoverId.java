...
/**
 * CaafTurnoverId generated by hbm2java
 */
@Embeddable
public class CaafTurnoverId implements java.io.Serializable {
	...
	public CaafTurnoverId() {
	}

	public CaafTurnoverId(Integer permno, Integer yrmo, BigDecimal value1,
	...
	@Column(name = "value1", precision = 10, scale = 9)
	...
	@Column(name = "value2", precision = 10, scale = 9)
	...
	@Column(name = "value3", precision = 10, scale = 9)
	...
	@Column(name = "value6", precision = 10, scale = 9)
	...
	@Column(name = "value24", precision = 10, scale = 9)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaafTurnoverId))
			return false;
		CaafTurnoverId castOther = (CaafTurnoverId) other;
